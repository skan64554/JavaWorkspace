...
public class ControlPractice {
	...
	public void practice1() {
		...
		case 7:
			System.out.print("종료");
			return; // 메서드를 종료, 현재 위치에서 메서드를 "종료"시키는 키워드
		default:
	...
	public void practice4() {
		...
		case (11):
			...
			break;
		default:
			System.out.println(A + "는 잘못 입력된 값 입니다.");
			return;
		}
	}
	...
	public void practice5() {
		...
		if (ID.equals("KMS") && PW.equals("3434"))
			...
			System.out.println("아이디가 틀리거나 정보가 아예 일치하지 않습니다.");
	...
	public void practice11() {
		...
		else if (a1 == a2 || a2 == a3 || a3 == a4 || a2 == a4 || a1 == a4 || a1 == a3)
