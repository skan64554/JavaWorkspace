...
public class A_StringPool {
	...
	public void method1() {
		// 리터럴시 상수풀에 저장
		String str = "hello";
		String str1 = new String("hello"); // new로 인해 힙메모리 저장
		...
		System.out.println(str1.hashCode()); // 주소값 반환 10진수
		System.out.println(str2.hashCode()); // 주소값 반환 10진수
		// 문자열 비교가 true면 해쉬코드 값도 같아야한다 -> 후술설명
		// 기존 hashcode()는 16진수 메모리 주소값을 10진수로 변환
		// String의 hashcode()메서드의 경우 주소값이 아닌 담긴 문자열을 
		// 10진수로 변환해주는 메서드로 오버라이딩
	...
	// 문자열 리터럴로 변수 초기화
	public void method2() {
		String str1 = new String("hello");// 힙 메모리 저장
		String str2 = "hello"; // 상수 풀에 저장
		 ...
		 * 3. 만약 이미 상수풀에 그 값이 저장되어 있다면, 저장되어 있는 주소값을 반환
		 */
		 ...
		 *   하거나 데이터가 없었다면 상수풀에 새롭게 값을 등록하고 그 주소값을 반환
		 */
		
		System.out.println(str1 == str2);
		System.out.println(str2 == str3);// JVM 기본 작동 방식
	 ...
	 * 
	 * 단, 문자열상수풀로도 감당이 불가능할 정도의 문자열 연산이 자주 사용되는 프로그램일 경우
	 * 문자열보다는 문자열기반 가변클래스인 (StringBuffer, StringBuilder)를 사용 권장
	 */
	...
	public void constant() {
		...
		final int AGE = 21;
		// 상수값을 저장하고 있는 변수의 이름은 "대문자"로 지정한다
	}
}
