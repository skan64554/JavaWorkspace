...
public class OptionalMethods {
	...
	/*
	 * Optional
	 *  - 자바 8부터 추가된 클래스로, 스트림에서 NPE, 기타 에러상황들을 방지하기 위한 용도로 사용
	 *  - Optional은 데이터를 직접 다루는 대신, optional 객체를 통해 간접적으로 다룬다.
	 *  - Optional을 객체로 사용할 때 Optional 내부에 데이터가 있는지 없는지 항상확인하는 절차를 강제함으로써 에러를 방지한다.
	...
	public static void main(String[] args) {
		/*
		 * Optional 객체 생성 방법
		 * 1. Optional.empty() : 값이 비어있는 Optional 객체 todtjd
